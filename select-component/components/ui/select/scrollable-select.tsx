...
export type ScrollableSelectProps = Omit<SelectProps, "options"> & {
  /** Array of timezone options or custom options */
  options?: SelectProps["options"]
}

/**
 * A pre-configured select component with timezone options that demonstrates scrolling
 */
export function ScrollableSelect({ options, ...props }: ScrollableSelectProps) {
  ...
  return (
    <Select
      ...
      placeholder={props.placeholder || "Select a timezone"}
      maxHeight={300}
      {...props}
    />
  )
