...
import { cn } from "@/lib/utils" // Use the existing utils from the project
...
export const SelectScrollUpButton = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ ...props }, ref) => {
    // This is just a wrapper for API compatibility
...
export const SelectScrollDownButton = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ ...props }, ref) => {
    // This is just a wrapper for API compatibility
    return <div ref={ref} {...props} />
  },
